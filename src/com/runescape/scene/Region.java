...
public class Region {
				...
				for (int i_169_ = 0; i_169_ < 64; i_169_++) {
					for (int i_170_ = 0; i_170_ < 64; i_170_++) {
						if (i_168_ == i && i_169_ >= i_161_ && i_169_ < i_161_ + 8 && i_170_ >= i_162_
								&& i_170_ < i_162_ + 8) {
							readMapTile(i_164_ + TiledUtils.getRotatedMapChunkY(i_169_ & 0x7, i_170_ & 0x7, i_158_), 0,
									buffer,
									i_160_ + TiledUtils.getRotatedMapChunkX(i_169_ & 0x7, i_170_ & 0x7, i_158_), plane,
									i_158_, 942, 0);
						} else {
							readMapTile(-1, 0, buffer, -1, 0, 0, 942, 0);
						}
					}
				}
			}
	...
	public final void readMap(byte[] bs, int i, int i_171_, int i_172_, int i_173_, byte b,
				...
				for (int i_177_ = 0; i_177_ < 4; i_177_++) {
					for (int i_178_ = 0; i_178_ < 64; i_178_++) {
						for (int i_179_ = 0; i_179_ < 64; i_179_++) {
							readMapTile(i_179_ + i, i_173_, buffer, i_178_ + i_171_, i_177_, 0, 942, i_172_);
						}
					}
				}
				if (b == 4) {
	...
	private final void readMapTile(int i, int i_180_, Buffer buffer, int i_181_, int i_182_, int i_183_, int i_184_,
			int i_185_) {
		try {
			i_184_ = 36 / i_184_;
